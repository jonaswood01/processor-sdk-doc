...
The following guide shows how to flash and boot from storage media such as the
eMMC card, SD card, and USB storage devices. While this is a step-by-step guide,
